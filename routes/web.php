...
Route::group(['namespace' => 'Botble\Payway\Http\Controllers', 'middleware' => ['core', 'web']], function () {
...
Route::group(['namespace' => 'Botble\Payway\Http\Controllers', 'middleware' => ['core']], function () {
